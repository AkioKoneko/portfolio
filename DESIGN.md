...
> This is adapted guidance for this portfolio where structure/content must stay intact.

## Intent

- Keep the portfolio recognizable and content-first.
- Apply changes selectively: typography, spacing, hierarchy, surfaces, controls.
- Preserve current IA, section order, and navigation behavior.
...
These tokens are intentionally conservative to avoid a redesign:
...
- **Cards/Accordions/Callouts**: soft border + very light shadow.
- **Links**: warm accent color; underline mainly on hover/focus.
- **Section banners/images**: preserve current media; only refine framing/shadow.
- **Mobile menu button**: keep behavior, align styling with accent and surface tokens.

## Anti-goals

- Do **not** convert this portfolio into a chat-app UI.
- Do **not** mimic a generic AI landing page aesthetic.
- Do **not** restructure sections or rewrite portfolio content.
